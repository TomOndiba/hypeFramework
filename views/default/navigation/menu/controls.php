...
$class = "elgg-menu elgg-menu-controls elgg-menu-{$vars['name']}";
if (isset($vars['class'])) {
	$class .= " {$vars['class']}";
}

echo '<div class="elgg-menu-controls-wrapper clearfix">';
foreach ($vars['menu'] as $section => $menu_items) {
	echo elgg_view('navigation/menu/controls/section', array(
		'items' => $menu_items,
