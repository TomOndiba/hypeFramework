...
framework.relationshiptags.init = function() {

    var source_entities = framework.relationshiptags.sourceentities;
...
elgg.register_hook_handler('init', 'system', framework.relationshiptags.init);
elgg.register_hook_handler('success', 'ajax', framework.relationshiptags.init, 500);
