...
function hj_framework_generate_entity_icons($entity, $field_name = 'icon') {

	$icon_sizes = hj_framework_get_thumb_sizes($entity->handler);
	...
	$filehandler->write(get_uploaded_file($field_name));
	$filehandler->close();
