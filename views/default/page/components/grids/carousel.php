...
$list_params = array('items', 'offset', 'limit', 'count', 'base_url', 'pagination', 'offset_key', 'position', 'list_class', 'list_id', 'data-options', 'item_view_params');
...
if ($list_id) {
	...
	$script = <<<___JS
		<script type="text/javascript">
			...
			if (!framework.data.lists) {
				framework.data.lists = new Object();
			}
			if (!framework.data.lists["$list_id"]) {
				framework.data.lists["$list_id"] = new Object();
				var init = true;
			}
